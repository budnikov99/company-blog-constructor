...
class AdminSettings extends AdminPanelExtension {
    ...
    public function getTemplateData(string $subpath, Request $request){
        return [
            'template' => '_basic/templates/admin-settings.html.twig',
            'data' => ['admins' => $this->managers[SiteManager::class]->getAdminAccounts()],
        ];
    }
}